...
main(int argc, char **argv){
	...
	/* Always pass either the static data or data on the heap to the timers
		and jobs in Async programming. Never pass stack local data*/
	static char *name = "Abhishek";
